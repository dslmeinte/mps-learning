...
<model ref="r:00d4cdea-53da-44e8-b327-356cf9443128(TypeSystemLearning.typesystem)">
  ...
  <node concept="3hdX5o" id="43ZC8WruXWi">
    ...
    <node concept="3ciAk0" id="43ZC8WruXWj" role="3he0YX">
      ...
      <node concept="2pJPEk" id="cNiNICqEy2" role="3ciSkW">
        <node concept="2pJPED" id="cNiNICqEOD" role="2pJPEn">
          <ref role="2pJxaS" to="awee:7Cs8ocvB3ay" resolve="StringType" />
        </node>
      </node>
      <node concept="2pJPEk" id="cNiNICqEPl" role="3ciSnv">
        <node concept="2pJPED" id="cNiNICqEPm" role="2pJPEn">
          <ref role="2pJxaS" to="awee:7Cs8ocvB3ay" resolve="StringType" />
        </node>
      </node>
    </node>
  ...
  <node concept="2sgARr" id="4V152FyA$bn">
    ...
    <node concept="3clFbS" id="4V152FyA$bo" role="2sgrp5">
      <node concept="3clFbF" id="cNiNICqAf8" role="3cqZAp">
        <node concept="3K4zz7" id="cNiNICqCgS" role="3clFbG">
          <node concept="2pJPEk" id="cNiNICqCqb" role="3K4E3e">
            <node concept="2pJPED" id="cNiNICqCzg" role="2pJPEn">
              <ref role="2pJxaS" to="awee:7Cs8ocvB3ay" resolve="StringType" />
              <node concept="2pJxcG" id="cNiNICqCzG" role="2pJxcM">
                <ref role="2pJxcJ" to="awee:7Cs8ocvB3az" resolve="maxLength" />
                <node concept="3cpWsd" id="cNiNICqDWJ" role="2pJxcZ">
                  <node concept="3cmrfG" id="cNiNICqDWM" role="3uHU7w">
                    <property role="3cmrfH" value="1" />
                  </node>
                  <node concept="2OqwBi" id="cNiNICqCHY" role="3uHU7B">
                    <node concept="1YBJjd" id="cNiNICqC$c" role="2Oq$k0">
                      <ref role="1YBMHb" node="4V152FyA$by" resolve="stringType" />
                    </node>
                    <node concept="3TrcHB" id="cNiNICqD7r" role="2OqNvi">
                      <ref role="3TsBF5" to="awee:7Cs8ocvB3az" resolve="maxLength" />
                    </node>
                  </node>
                </node>
          ...
          <node concept="10Nm6u" id="cNiNICqE6h" role="3K4GZi" />
          <node concept="3eOSWO" id="cNiNICqBsS" role="3K4Cdx">
            <node concept="3cmrfG" id="cNiNICqBsV" role="3uHU7w">
              <property role="3cmrfH" value="0" />
            </node>
            <node concept="2OqwBi" id="cNiNICqAmR" role="3uHU7B">
              <node concept="1YBJjd" id="cNiNICqAf7" role="2Oq$k0">
                <ref role="1YBMHb" node="4V152FyA$by" resolve="stringType" />
              </node>
              <node concept="3TrcHB" id="cNiNICqABB" role="2OqNvi">
                <ref role="3TsBF5" to="awee:7Cs8ocvB3az" resolve="maxLength" />
              </node>
            </node>
          </node>
